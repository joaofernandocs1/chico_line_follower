...
int sen_NB = 0; // sensor Nível de Bateria
...
boolean chk_dir (float erro_neg_esq, float erro_pos_dir)
{
   ...
   else if (erro_neg_esq < erro_pos_dir)
   {
      ...
      bloco_i += Ki*(erro_pos_dir)*delta*0.001; // 0.001 para passar delta para segundos
...
void f5_param_disp() {
   ...
   // troca index do display

   // sai das confs para as constantes mas n volta
   // REVER LÓGICA
